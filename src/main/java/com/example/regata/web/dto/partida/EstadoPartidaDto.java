...
public class EstadoPartidaDto {
    ...
    private List<String> layout; // líneas ASCII
    private int maxJugadores;
    private Long ganadorParticipanteId; // null si no hay
    ...
    public String getMapaNombre() { return mapaNombre; }
    public void setMapaNombre(String mapaNombre) { this.mapaNombre = mapaNombre; }
    ...
    public Long getGanadorParticipanteId() { return ganadorParticipanteId; }
    public void setGanadorParticipanteId(Long ganadorParticipanteId) { this.ganadorParticipanteId = ganadorParticipanteId; }
